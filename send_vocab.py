...
- GEMINI_MODEL                : (tuỳ chọn) model Gemini, mặc định "gemini-3.7-flash"
"""
...
def generate_paragraph(sample, max_retries=3):
    ...
    for attempt in range(1, max_retries + 1):
        try:
            ...
            # Lỗi tạm thời phía server Google (quá tải / rate limit) -> thử lại.
    ...
    # Hết số lần thử mà vẫn dính lỗi server tạm thời (429/5xx)
